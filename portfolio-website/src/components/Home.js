  ...
  return (
    <div id='body' className='pt-12 bg-gunmetal text-white'> {/* Added padding-top to account for header navigation */}
      <div id='home-header' className="py-16">
        <div className="container mx-auto flex flex-col md:flex-row items-start justify-between max-w-6xl px-4">
          <div className="md:w-1/2 text-left">
            <h1 className="py-4 text-6xl md:text-8xl font-bold">Katrina Dotzlaw</h1>
            <h2 className='text-3xl md:text-4xl py-4'>Software Developer</h2>
          </div>
          <div className="md:w-1/2 mt-8 md:mt-0">
            <div className="py-4 text-pretty flex-1 bg-teal bg-opacity-10 rounded-lg p-6">
              <div className="flex flex-col space-y-6 text-left bg-gunmetal shadow-lg rounded-lg overflow-hidden card">
                <img src={profilePic} alt="Katrina Dotzlaw" className="w-64 h-64 object-cover rounded-full mx-auto"/>
